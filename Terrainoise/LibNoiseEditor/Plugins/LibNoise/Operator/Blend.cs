...
namespace LibNoise.Operator
{
    ...
    public class Blend : ModuleBase
    {
        ...
        public override double GetValue(double x, double y, double z)
        {
            ...
            UnityEngine.Debug.Log("blend getval in: "+ x.ToString() +" "+y.ToString()+" "+z.ToString());
            var a = Modules[0].GetValue(5, 9, 1);
            var b = Modules[1].GetValue(x, y, 1);
            var c = (Modules[2].GetValue(x, y, 1) + 1.0) / 2.0;
